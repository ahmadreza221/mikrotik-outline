# MikroTik VLESS VPN Complete Setup Script
# For hAP lite (RB941-2nD) with automatic RouterOS update
# 
...
# ============================================================================
# SECTION 1: VERSION CHECK AND UPDATE
# ============================================================================

:log info "Starting MikroTik VLESS VPN Complete Setup"
...
# Check if version is below 7.14
:if ([:pick $current_version 0 3] < "7.1") do={
    :log warning "RouterOS version is below 7.14. Attempting to update..."
    
    # Download RouterOS 7.14 for hAP lite (mipsbe)
    :log info "Downloading RouterOS 7.14..."
    ...
    :if ([:len [/file find name=routeros-update.npk]] > 0) do={
        :log info "RouterOS update downloaded successfully. Installing..."
        /system package install routeros-update.npk
        :log warning "RouterOS update installed. Router will reboot in 10 seconds..."
        :delay 10s
        /system reboot
    } else={
        :log error "Failed to download RouterOS update. Please update manually."
        :log error "Download from: https://mikrotik.com/download"
    }
}
...
:if ([:len [/system package find name=container]] = 0) do={
    :log info "Container package not found. Attempting to install..."
    
    # Try to download container package for mipsbe
    ...
    :if ([:len [/file find name=container-package.npk]] > 0) do={
        :log info "Container package downloaded. Installing..."
        /system package install container-package.npk
        :log info "Container package installed successfully."
    } else={
        :log error "Failed to download container package. Please install manually."
        :log error "Download from: https://mikrotik.com/download"
    }
} else={
    :log info "Container package is already installed."
}
...
:log info "User management completed - outline user created, admin disabled"
...
:log info "Interface configuration completed"

# ============================================================================
# SECTION 5: BRIDGE CONFIGURATION
# ============================================================================
...
:log info "WiFi configuration completed - SSID: outline360, Password: outline"

# ============================================================================
# SECTION 7: IP ADDRESS CONFIGURATION
# ============================================================================
...
:log info "IP address configuration completed"
...
:log info "DHCP server configuration completed"
...
# ============================================================================
# SECTION 10: BASIC FIREWALL RULES
# ============================================================================
...
# ============================================================================
# SECTION 11: CONTAINER CONFIGURATION
# ============================================================================
...
:log info "Container network configuration completed"
...
# ============================================================================
# SECTION 13: NAT CONFIGURATION
# ============================================================================

# Masquerade for LAN and container subnets
/ip firewall nat add chain=srcnat out-interface-list=WAN action=masquerade

:log info "NAT configuration completed"

# ============================================================================
# SECTION 14: CONTAINER DEPLOYMENT
# ============================================================================
...
# ============================================================================
# SECTION 15: VPN RECONNECTION SCRIPT
# ============================================================================
...
:log info "VPN reconnection script created"

# ============================================================================
# SECTION 16: SCHEDULER FOR VPN MONITORING
# ============================================================================
...
:log info "VPN monitoring scheduler created"

# ============================================================================
# SECTION 17: VLESS KEY UPDATE SCRIPT
# ============================================================================
...
:log info "VLESS key update script created"

# ============================================================================
# SECTION 18: FINAL CONFIGURATION
# ============================================================================
